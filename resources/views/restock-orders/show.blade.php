...
@section('content')
    <div class="p-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-4">Detail Restock</h1>
        <p class="text-gray-600">Halaman ini akan menampilkan detail restock. Fitur ini belum lengkap.</p>
